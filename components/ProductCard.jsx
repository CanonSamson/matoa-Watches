...
const ProductCard = ({ image, name, rate, beforeprice, price }) => {
  return (
    <div className=" bg-white mt-[20%] text-[12px] p-2 md:p-4 leading-none">
      <Image
      ...
      <div className=" mt-2">
        ...
        <div className="mt-3">
          ...
          <span className=" md:text-base">{price}</span>
        </div>
      </div>
      <div className=" mt-2 items-center grid grid-cols-3 gap-2">
        ...
        <button className=" col-span-2 flex items-center gap-2 text-white  h-[39px] justify-center  md:px-5 bg-primary"> <span>Add to cart</span></button>
      </div>
    </div>
  );
};
